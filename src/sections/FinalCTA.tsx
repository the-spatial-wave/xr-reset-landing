  ...
  return (
    <section className="py-24 relative overflow-hidden bg-brand-void border-y border-[rgba(255,47,214,0.1)]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h2 className="text-4xl md:text-6xl font-display font-black text-white mb-6 uppercase tracking-tight">Smetti di guardare. <br/><span className="text-brand-magenta text-gradient">Inizia a costruire.</span></h2>
        ...
        <a href="#pricing" className="inline-flex items-center justify-center px-10 py-5 bg-brand-cyan text-brand-void font-bold text-lg rounded-sm overflow-hidden shadow-[0_0_30px_rgba(0,229,255,0.4)] transition-transform hover:scale-105">
